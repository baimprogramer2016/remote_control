<?php 
 ...
 $datascheduler = getAllDataLighting();
?>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-row justify-content-between">
                      <h4 class="card-title mb-1">Lighting</h4>
                      ...
                      <div class="col-12">
                        <div class="preview-list">
                              ...
                              foreach($datascheduler as $value)
                              {
                                ...
                                $area         = $value['area'];
                                $datalighting = $value['datalighting'];
                              ...
                              <div class="preview-item border-bottom">
                                ...
                                <div class="row w-100 text-search">
                                    ...
                                    onclick="return goToUpdateLighting('<?php echo $id;?>')"
                                  >
                                    Update
                                  </button>
                                    </div>
...
<script>
  ...
  function goToUpdateLighting(param) {
    location.href = "main.php?page=schedule-lighting-edit&param_id="+param;
  }
