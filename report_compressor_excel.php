...
<?php
  ...
  $this_url = "https://newlph.akebono-astra.co.id/report_power_house_line.php";
  $this_title = '';
...
<body>
	<div id="outerContainer">
		...
		<div id="bodyContainer">
		  <!-- <div id="pageBodyTitle">REPORT POWER HOUSE MONITORING</div> -->
      ...
      <table id="searchTable">	
        <thead>
          ...
          <tr>
            <td class="heading" style="color: white;background-color: #0066CC;text-align:center; width: 50px ;border:thin gray solid;"><b>NO</b></td>
            <td class="heading" style="color: white;background-color: #0066CC;text-align:center;border:thin gray solid;"><b>DATE<?= ( $_GET['date'] && $_GET['panel_id'] ) ? " | TIME" :"" ?></b></td>
            <?php if( !$_GET['panel_id'] ): ?>
            <td class="heading" style="color: white;background-color: #0066CC;text-align:center;border:thin gray solid;"><b>PANEL</b></td>
            <?php endif; ?>
            <td class="heading" style="color: white;background-color: #0066CC;text-align:center;border:thin gray solid;"><b>TOTAL CONSUMPTION</b></td>
          
            <td class="heading" style="color: white;background-color: #0066CC;text-align:center;border:thin gray solid;"><b>COST ENERGY</b></td>
            <td class="heading" style="color: white;background-color: #0066CC;text-align:center;border:thin gray solid;"><b>CO2 EMISSION</b></td>
            <td class="heading" style="color: white;background-color: #0066CC;text-align:center;border:thin gray solid;"><b>COST CO2</b></td>
          </tr>
        </thead>
        <tbody>
          <?php $i=1; $total_usage = array(); ?>
            ...
            <?php if( $data && $_GET['date'] && $_GET['panel_id'] ): ?>
              <?php foreach($data as $row): ?>
                ...
                <tr>
                  ...
                  <td style="text-align:center;border:thin gray solid;"><?= date('d-M-Y | H:i', strtotime($row['date'])) ?></td>
                  <?php if( !$_GET['panel_id'] ): 
                  ...
                  <?php endif; ?>
                  <td style="text-align:center;border:thin gray solid;"><?= number_format($row['kwh']); ?> KWH</sup></td>
              ...
              <?php endforeach; ?>
              <tr>
                <td style="text-align:center;border:thin gray solid;font-weight: bold;color: red;" colspan="<?= (!$_GET['panel_id']) ? 3 : 2; ?>">TOTAL CONSUMPTION</td>
            ...
            <?php elseif( $data && $_GET['date'] ): ?>
              ...
              <?php endforeach; ?>
              <!-- <tr>
                <td style="text-align:center;border:thin gray solid;;" colspan="<?= (!$_GET['panel_id']) ? 3 : 2; ?>">TOTAL CONSUMPTION</td>
                <td colspan="1" style="text-align:right;border:thin gray solid;"><?= number_format(array_sum($total_usage)); ?> kWh</sub></td>
                <td colspan="1" style="text-align:right;border:thin gray solid;">Rp. <?= number_format(array_sum($total_cost_energy)); ?></sub></td>
                <td colspan="1" style="text-align:right;border:thin gray solid;"><?= number_format(array_sum($total_co2)); ?></sub></td>
                <td colspan="1" style="text-align:right;border:thin gray solid;">Rp. <?= number_format(array_sum($total_cost_co2)); ?></sub></td>
              </tr> -->
            ...
            <?php elseif( $data && $_GET['month'] ): ?>
                ...
                <?php foreach($datadet as $rowdet): 
                  ...
                  ?>
                      <tr>
                        ...
                        <td style="text-align:center;border:thin gray solid;"><?= number_format($rowdet['daily_use']); ?> KWH</sup></td>
              ...
              <?php endforeach; ?>
              <!-- <tr>
                <td style="text-align:center;border:thin gray solid;;" colspan="<?= (!$_GET['panel_id']) ? 3 : 2; ?>">TOTAL MONTH CONSUMPTION</td>
                <td colspan="1" style="text-align:center;border:thin gray solid;"><?= number_format(array_sum($total_usage)); ?> kWh</sub></td>
              </tr> -->
