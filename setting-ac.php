...
<div class="page-header">
  <h3 class="page-title">Air Conditioner Remote Control</h3>
  <a   onclick="return goFloor()" class="nav-link btn btn-inverse-warning create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="#">Back to Area</a>
</div>
                    ...
                    <div class="row" id="rowListRoom">
                      ...
                      <div class="col-12">
                        <div class="preview-list">
                            ...
                            $querycategory  =   mssql_query("SELECT * FROM AC_akebono WHERE floor ='".$param_floor."' ORDER BY Description ASC");
...
<script>
  function goFloor(param) {
    // alert("hai");
    location.href = "main.php?page=group-setting-ac";
  }
</script>
