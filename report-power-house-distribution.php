...
<h3 class="page-title">Report Power House</h3>
</div>
<div class="row">
                  ...
                  <!-- BULAN -->
                   ...
                   <?php $desc = query("SELECT TOP(1) description FROM PHouse_act_status WHERE panel_id='$row[panel_id]'")[0]['description']; ?>
                        <tr style='color:#cedadc;'>
                            ...
                            ?>
                            <td> <?= number_format($row['daily_use']);?> KWH  </td>
                            <td>  <a href="<?= $this_url; ?>&month=<?= $_GET['month']; ?>&panel_id=<?= $row['panel_id'] ?>"><i class="mdi mdi-table-edit text-primary" size></i> </a> </td>
                            <td> Rp. <?= number_format($cost_energy); ?> </td>
                            <td> <?= number_format($co2); ?> kg-CO2 </td>
                            <td> Rp. <?= number_format($cost_co2); ?> </td>
                        </tr>
                          ...
                          <tr>
                            <td colspan="8">
                              <div class="alert alert-primary" role="alert">
                               No Data Available <?php echo $_GET['month'].' '.$_GET['date'];?>
                              </div> 
                            </td>
                          </tr>
                          <?php else: ?>
...
<script>
   ...
   $("#btnDownload").on('click', function() {
      ...
      var fileRpt = "report_power_house_distribution_excel.php?date=" + date+"&month=" + month;
      // alert(fileRpt);
      // console.log(fileRpt)
