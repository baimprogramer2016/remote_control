...
$(function() {
    ...
    function getChart(param_tank_id, param_color)
    {
      
      $.ajax({
        type: "GET",      
        url: 'getdatatank.php?request_data=data_tank_id&tank_id='+param_tank_id+'&color='+param_color,
        success: function(responsdatapanel){
          ...
          // console.log(datacolor);
            ...
            var data = {
              ...
              if(param_tank_id != "" || param_tank_id != null)
              {
              var barChartCanvas = $("#"+param_tank_id)//.get(0).getContext("2d");
    ...
    $.ajax({
      type: "GET",      
      url: 'getdatatank.php?request_data=tank_id',
      success: function(responsepanel){
        ...
        datajson.forEach(function(datapanel){
          ...
          getChart(datapanel.tank_id, datapanel.color);
        });        
      }
    });
