...
<?php
   ...
   //  $dataStatusAcFromApiAssy  = statusLightingFromApiAssy();
$querycategoryip      =   mssql_query("SELECT ip_address FROM Lighting_akebono WHERE  Description is not null ".$param_area."  ORDER BY Description ASC");
$rescategoryip        =   mssql_fetch_assoc($querycategoryip);   
$dataStatusAcFromApi  =   statusLightingFromApiNew(''.$rescategoryip['ip_address'].'');

// if(count($dataStatusAcFromApi) == 0 || $dataStatusAcFromApiAssy==0){
...
<div class="page-header">
  <h3 class="page-title">Lighting Remote Control</h3>
                    ...
                    <div class="row" id="rowListRoom">
                      ...
                      <div class="col-12">
                        <div class="preview-list">
                            ...
                            $querycategory  =   mssql_query("SELECT * FROM Lighting_akebono WHERE  Description is not null ".$param_area."  ORDER BY Description ASC");
                            ...
                            if($cekcategory != 0 )
                            {
                              ...
                              $area         = $rcategory['Area'];
                                ...
                                $statusac  = cekStatusLighting($dataStatusAcFromApi, $address);
                                if($statusac['status'] == 'level=255' || $statusac['status'] == '1')
                                {
                                    $checkedAc = 'checked';
                                }
                                else
                                ...
                                <div class="row d-flex justify-content-center">
                                  <label class="skeuo__switch mt-2">
                                    ...
                                    <?php echo $checkedAc; ?>
                                      ...
                                      class="skeuo__input"
                                      onClick="return onOffLamp('<?php echo $rcategory['ip_address']; ?>','<?php echo $rcategory['id'];?>','<?php echo $rcategory['Address'];?>')"
...
<script>
  ...
  function goArea(param) {
    // alert("hai");
    location.href = "main.php?page=group-setting-lighting";
  }
</script>
...
<script>
        ...
        function onOffLamp(paramIp,paramId,paramAddress){
          ...
          urlelectriclamp = "process_lighting.php?ip_address="+paramIp+"&id="+paramId+"&statusaction="+statuslamp+"&address=" + paramAddress;
