...
$datalcompressoredit   = getDataCompressor($_GET['param_id']);
$id           = $datalcompressoredit[0]['id'];
$address      = $datalcompressoredit[0]['address'];
$area         = $datalcompressoredit[0]['area'];
$ip_address   = $datalcompressoredit[0]['ip_address'];
$description  = $datalcompressoredit[0]['description'];
$datacompressor = $datalcompressoredit[0]['datacompressor'];
$onscheduler  = $datalcompressoredit[0]['onscheduler'];
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-inline">
                      ...
                      <button
                        onClick="saveScheduleCompressor()"
                        type="submit"
                      ...
                      <button
                        onClick="return backScheduleCompressor()"
                        type="submit"
...
function deleteSchedule(param_id)
{
    ...
    $.ajax({
                ...
                url  : "process.php?type=scheduler-compressor-delete&param_id="+param_id,  //your page
 ...
 //save data 
function saveScheduleCompressor()
{
  ...
  if(schedule_time === '')
  {
    ...
    $.ajax({
              ...
              url  : "process.php?type=scheduler-compressor-submit",  //your page
...
//back 
function backScheduleCompressor()
{
  location.href = "main.php?page=schedule-compressor";
}
</script>
